...
class MoneyOrder(models.Model):
    ...
    state = fields.Selection([
        ...
        ('done', u'已完成'),
        ('cancel', u'已作废'),
    ], string=u'状态', readonly=True, default='draft', copy=False, index=True,
...
class MoneyInvoice(models.Model):
    ...
    def compute_overdue(selfs):
        ...
        for self in selfs:
            ...
            d2 = self.date_due and self.date_due or d1
            day = (d1 - d2).days
    ...
    def money_invoice_done(self):
        ...
        for inv in self:
            ...
            inv.date_due = fields.Date.context_today(self) + datetime.timedelta(days=inv.partner_id.credit_time)
