...
class StockRequestLine(models.Model):
    ...
    to_sell_qty = fields.Float('未确认销货数量', digits='Quantity')
    to_delivery_qty = fields.Float(
        '未发货数量', digits='Quantity')
    to_buy_qty = fields.Float('未确认购货数量', digits='Quantity')
    to_receipt_qty = fields.Float(
        '未到货数量', digits='Quantity')
    ...
    to_produce_qty = fields.Float(
        '未完工数量', digits='Quantity')
    to_consume_qty = fields.Float(
        '未投料数量', digits='Quantity')
